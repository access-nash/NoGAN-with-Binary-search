# -*- coding: utf-8 -*-
"""
Created on Fri Oct 20 07:35:27 2023
...
#        Faster implementation: replaced 'while' loop by binary search
...
for obs in npdata:
    ...
    for k in range(n_features):
        ...
        left, right = 0, bins_per_feature[k]-1
...
#Better visualization of ECDF scatterplot
...
plt.subplot(1, 3, 3)
plt.scatter(ecdf_realx, ecdf_synthx, s = 0.1, c ="orange")
plt.xticks(list(x_labels.keys()), x_labels.values())
plt.yticks(list(y_labels.keys()), y_labels.values())
plt.show()
